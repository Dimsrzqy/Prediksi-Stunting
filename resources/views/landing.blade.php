...
<head>
    ...
    <style>
        ...
        .orbit-2 {
            width: 70vw;
            height: 70vw;
            animation: spin-orbit-reverse 60s linear infinite;
        ...
        .animate-float-anti-1 {
            animation: float-anti-1 8s ease-in-out infinite;
        }

        .animate-float-anti-2 {
            animation: float-anti-2 10s ease-in-out infinite 1s;
        }
        ...
        .animate-float-delayed {
            animation: float-delayed 5s ease-in-out infinite 2.5s;
        }
