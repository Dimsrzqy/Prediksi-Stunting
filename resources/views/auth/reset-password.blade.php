    ...
    <div class="w-full max-w-md relative z-10">
        <div class="glass-panel rounded-3xl p-8 sm:p-10 relative overflow-hidden group">
            ...
            <div class="flex flex-col items-center mb-10 relative z-10">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight text-center">{{ __('Reset Password') }}</h1>
                <p class="text-gray-500 dark:text-gray-400 text-sm mt-2 text-center leading-relaxed">
                    {{ __('Set your new password below.') }}
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-5 relative z-10">
                ...
                @enderror
                @error('token')
                    <p class="mt-1 text-xs text-red-500 font-medium ml-1 text-center">{{ $message }}</p>
                @enderror

                <div class="space-y-1.5">
                    <label for="password" class="text-sm font-medium text-gray-700 dark:text-gray-300 ml-1">{{ __('New Password') }}</label>
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" required autofocus
                            ...
                            placeholder="••••••••">
                        <button type="button" onclick="togglePassword('password', 'eye-icon-1')" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-blue-500 transition-colors">
                ...
                <div class="space-y-1.5">
                    <label for="password_confirmation" class="text-sm font-medium text-gray-700 dark:text-gray-300 ml-1">{{ __('Confirm New Password') }}</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        ...
                        <input id="password_confirmation" name="password_confirmation" type="password" required
                            class="w-full px-4 py-3 rounded-xl bg-white/50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-300 pl-11 pr-11"
                            placeholder="••••••••">
                        <button type="button" onclick="togglePassword('password_confirmation', 'eye-icon-2')" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-blue-500 transition-colors">
